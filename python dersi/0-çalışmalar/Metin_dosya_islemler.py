class Dosya():
    ...
    def __init__(self):
        with open("metin.txt","r",encoding = "utf-8") as file:
            ...
            kelimeler = dosya_icerigi.split() # () içine ne yazılırsa örn: ("*") metinde "*" karakterinin bulunduğu yerden keser kelimeleri listeye atar

            self.sade_kelimeler = list()

            for i in kelimeler:
                i = i.strip("\n")# kelimenin başında veya sonunda \n var ise onu siler
                i = i.strip(".")
                i = i.strip(",")
                i = i.strip(" ")
